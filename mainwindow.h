...
public:
    ...
    int cameraWidth;
    int cameraHeight;
//    int DahengAcquisitionThread(QObject* parent = 0) {};
...
private:
  ...
  //  int OnSnapChange();
    ...
    ///////////////////////////////
    GX_DEV_HANDLE	m_hhv_1;			///< maniglia della fotocamera digitale
    GX_DEV_HANDLE	m_hhv_2;

    BYTE *ppBuf_1[1];
    BYTE *ppBuf_2[1];

    BYTE *m_pRawBuffer_1;		///< Acquisisci il buffer di dati grezzi dell'immagine
    BYTE *m_pRawBuffer_2;

    static int CALLBACK SnapThreadCallback(GX_FRAME_CALLBACK_PARAM*pInfo);
    ////////////////////////////////////////////////
    ///与set对话框有关的变量
    int black_ ;
    int white_;
